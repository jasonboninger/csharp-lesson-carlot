namespace CarLot.Concepts
{
	public class LearningVariables
	{
		public LearningVariables()
		{
			...
			// The type of a variable can never be changed after being declared

			var myDynamicString = "I am a string...";

			//myDynamicString = 10; // <-- Will not compile!
...
// 1) Console log a message from a variable.
